...
```bash
# Make sure you're in tak-server-installer/ubuntu-22.04/ with the .deb file
...
```bash
# Make sure you're in tak-server-installer/rocky-9/ with the .rpm file
...
```bash
# Run from tak-server-installer/ubuntu-22.04/ directory
...
```bash
# Run from tak-server-installer/rocky-9/ directory
